use sysinfo::{SystemExt, System, Pid, PidExt, ProcessExt, ComponentExt};
...
pub fn get_processes(sys: &System) {
...
pub fn kill_process(sys: &System, pid: usize) {
...
pub fn get_disk_usage(sys: &System) {
    let mut table = tabular::Table::new("{:<}  {:<} {:<} {:<}");
...
pub fn get_component_temperature(sys: &System) {
    let mut table = tabular::Table::new("{:<}\t\t{:>}\t{:>}\t\t{:>}");
